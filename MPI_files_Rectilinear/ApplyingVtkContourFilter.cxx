...
int main(int argc, char *argv[])
{
    ...
    if (rank >= 1)
    {
        ...
        // Send this temporary file name to the parent process
    ...
    else
    {
    	...
    	snprintf(strPDNew, 7, "%f", time);

        fputs(strPDNew, out_file);
